...
/**
 * FlightSearchItinerary Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FlightSearchItinerary implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlightSearchItinerary';
    ...
    /**
     * Sets outbound
     * @param \Swagger\Client\Model\FlightSearchBound $outbound The bound container for the flight information for bringing the traveler from the origin airport to the destination airport
     * @return $this
     */
    ...
    /**
     * Sets inbound
     * @param \Swagger\Client\Model\FlightSearchBound $inbound The bound container for the flight information for bringing the traveler from the destination airport to the origin airport
     * @return $this
     */
